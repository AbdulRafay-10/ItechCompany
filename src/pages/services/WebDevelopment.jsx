...
import heroImage from '../../assets/Services/Web-Development/heroImg.webp'
import p1 from '../../assets/Services/Web-Development/p1.webp'
import p2 from '../../assets/Services/Web-Development/p2.webp'
...
const WebDevelopment = () => {
  const serviceData = {
    ...
    overview: [
      'Our web development team creates robust, scalable, and high-performance websites and web applications. We use cutting-edge technologies and frameworks to deliver solutions that meet your business objectives.',
      'From responsive websites to complex web applications, we provide end-to-end development services that ensure optimal performance, security, and user experience.',
      'We follow agile development methodologies and maintain high coding standards to deliver projects on time and within budget.'
    ],
    whyChooseUs: [
      'Modern frameworks and technologies (React, Vue, Angular)',
      'Responsive design for all devices',
      'SEO-optimized and fast-loading websites',
