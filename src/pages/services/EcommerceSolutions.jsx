import heroImage from '../../assets/Services/E-Commerce/HeroImg.webp'
import p1 from '../../assets/Services/E-Commerce/p1.webp'
import p2 from '../../assets/Services/E-Commerce/p2.webp'
...
const EcommerceSolutions = () => {
  const serviceData = {
    ...
    heroImage: heroImage,
    heroImageAlt: 'E-commerce Solutions',
    overview: [
      'We build comprehensive e-commerce platforms that drive sales and provide exceptional shopping experiences. Our solutions are designed to handle high traffic, secure transactions, and seamless user journeys.',
      'From custom e-commerce websites to marketplace integrations, we provide end-to-end solutions that help businesses scale their online presence and increase revenue.',
      'Our e-commerce platforms include advanced features like inventory management, payment processing, order tracking, and analytics to help you make data-driven decisions.'
    ],
    whyChooseUs: [
