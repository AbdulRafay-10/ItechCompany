import heroImage from '../../assets/Services/Testing/heroImg.webp'
import p1 from '../../assets/Services/Testing/p1.webp'
import p2 from '../../assets/Services/Testing/p2.webp'
...
const TestingQA = () => {
  const serviceData = {
    ...
    heroImage: heroImage,
    heroImageAlt: 'Testing & QA Services',
    overview: [
      'Our comprehensive testing and quality assurance services ensure your applications are bug-free, performant, and user-friendly. We use industry-standard testing methodologies and tools to deliver reliable software solutions.',
      'From manual testing to automated testing frameworks, we provide end-to-end testing services that cover functional, performance, security, and usability testing.',
      'Our QA team works closely with development teams to implement testing strategies that prevent defects and ensure high-quality deliverables.'
    ],
    whyChooseUs: [
