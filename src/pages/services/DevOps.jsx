import heroImage from '../../assets/Services/DevOps/heroImg.webp'
import p1 from '../../assets/Services/DevOps/p1.webp'
import p2 from '../../assets/Services/DevOps/p2.webp'
...
const DevOps = () => {
  const serviceData = {
    title: 'DEVOPS',
    heroImage: heroImage,
    heroImageAlt: 'DevOps Services',
    overview: [
      'Our DevOps services help organizations streamline their development and deployment processes. We implement CI/CD pipelines, infrastructure automation, and monitoring solutions to improve efficiency and reliability.',
      'We work with cloud platforms like AWS, Azure, and Google Cloud to provide scalable and secure infrastructure solutions. Our team ensures your applications are deployed efficiently and maintained with minimal downtime.',
      'From containerization with Docker to orchestration with Kubernetes, we provide comprehensive DevOps solutions that accelerate your development lifecycle.'
    ],
    whyChooseUs: [
