  ...
  return (
    <section className="w-full mb-24">
      <div className="max-w-[1400px] mx-auto px-4 md:px-12 py-10 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-center">
        <div className="relative flex items-center justify-center md:justify-start min-h-[380px] md:min-h-[480px]">

          {/* three layered images on the left */}
          <div className="relative w-full max-w-[520px] overflow-visible -ml-14 -mt-72">
            <img src={imgA} alt="team-1" className="absolute left-0 top-6 w-[100%] rounded-lg shadow-2xl" />
            {/* White Experience Card replacing middle image */}
        ...
        <div className="space-y-6 text-center md:text-left md:pl-6 lg:pl-10">
          ...
          <div className="space-y-3">
            ...
            <div className="border-[2px] border-primary rounded-md p-4 md:w-[420px] md:ml-auto md:mt-8 lg:w-[520px] lg:mt-12">
              <div className="">
                <img src={logo} alt="compliant-logos" className="w-[600px] h-[200px]" />
              </div>
            </div>
          </div>
        </div>
