    ...
    <section className="w-full bg-gray-50  ">
      <div className="max-w-[1400px]  mx-auto px-4 md:px-12 py-14 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        <div className="space-y-8">
          ...
          <h2 className="text-2xl md:text-5xl font-bold text-slate-700 ">Trusted by 150+ <br /> Happy Customers</h2>
          ...
          <ul className="space-y-3 text-slate-700 gap-3 text-2xl text-text font-semibold">
